...
module.exports = function(app) {
  ...
  app.post("/api/stats", function(req, res) {
    ...
    db.sequelize.query("SELECT date, points, rebounds, assists, steals, blocks FROM players INNER JOIN stats ON players.pid=stats.pid where stats.pid=" + 
      req.params.id + " limit 10").then(function(data){
